    ...
    <div className="min-h-screen bg-bg-primary">
      <div className="mx-auto max-w-lg px-6 py-12 md:py-16">
        ...
        <p className="mt-4 text-sm font-light leading-relaxed text-cream-muted/60">
          Введите номер заказа и телефон, которые указали при оформлении.
          Страница работает с любого устройства — сохранять сайт открытым не
          нужно. Номер заказа выглядит так:{' '}
